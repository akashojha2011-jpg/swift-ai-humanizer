  ...
  return (
    <div className="space-y-10 font-sans">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 border-b border-slate-200 dark:border-slate-800">
        ...
        <Link
          href="/#humanizer"
          className="flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-semibold text-white bg-brand-600 hover:bg-brand-700 shadow-sm transition-all cursor-pointer"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 p-6 rounded-2xl space-y-2 shadow-card transition-colors">
          ...
          <div className="font-heading font-extrabold text-4xl text-brand-600 dark:text-emerald-400">
            {history.length}
          </div>
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 rounded-2xl p-6 space-y-4 shadow-card transition-colors">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 pt-1">
          ...
          <div className="flex items-center gap-2 shrink-0 w-full sm:w-auto">
            <button
              onClick={copyKey}
              className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl text-xs font-semibold bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-750 text-slate-700 dark:text-slate-200 shadow-2xs cursor-pointer"
            >
            ...
            <button
              ...
              className="flex-1 sm:flex-none px-4 py-2.5 rounded-xl text-xs font-semibold bg-amber-50 dark:bg-amber-950/70 border border-amber-200 dark:border-amber-800 text-amber-800 dark:text-amber-300 hover:bg-amber-100 dark:hover:bg-amber-900 cursor-pointer"
            >
              Regenerate
            </button>
          </div>
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 rounded-2xl p-6 space-y-4 shadow-card transition-colors">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
          <div className="flex items-center gap-2">
            <Clock className="w-5 h-5 text-brand-600 dark:text-emerald-400" />
            <h3 className="font-heading font-bold text-lg text-slate-900 dark:text-white">
          ...
          {history.length > 0 && (
            <button
              ...
              className="text-xs text-slate-500 dark:text-slate-400 hover:text-rose-600 dark:hover:text-rose-400 flex items-center gap-1 cursor-pointer"
            >
        ...
        {history.length === 0 ? (
          <div className="text-center py-10 space-y-2">
            ...
            <p className="text-xs text-slate-400 dark:text-slate-500">No documents saved yet in this session.</p>
          </div>
        ) : (
