...
const DETECTORS: DetectorLogo[] = [
  {
    ...
    icon: (
      <svg width={20} height={20} className="w-5 h-5 shrink-0" viewBox="0 0 24 24" fill="none">
...
export function DetectorMarquee() {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-6 sm:p-7 shadow-xs max-w-6xl mx-auto space-y-4 overflow-hidden transition-colors">
