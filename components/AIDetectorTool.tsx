...
export function AIDetectorTool() {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 sm:p-8 rounded-3xl space-y-6 shadow-float font-sans">
      ...
      <button
        onClick={handleScan}
        disabled={!input.trim()}
        className="w-full py-3.5 rounded-full font-heading font-bold text-xs text-white bg-brand-600 hover:bg-brand-700 disabled:opacity-40 shadow-md flex items-center justify-center gap-2 transition-all hover:scale-[1.01] cursor-pointer"
      >
        ...
        <div className="space-y-6 pt-4 border-t border-slate-100 dark:border-slate-800">
          ...
          <div className={`p-6 rounded-2xl border flex flex-col sm:flex-row items-center justify-between gap-4 ${
            ...
            <div className="text-center shrink-0">
              ...
              <div className="text-[10px] font-mono font-semibold opacity-75">AI Probability</div>
            </div>
          </div>
